...
import com.sql.logic.engine.common.DCC.config.DynamicConfigCenterAutoProperties;
...
public class DynamicConfigCenterService implements IDynamicConfigCenterService {
    ...
    public Object proxyObject(Object bean) {
        // After using AOP proxy, the way to get the Class is AopProxyUtils.getTargetClass(bean) istead of bean.class
