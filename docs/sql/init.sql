...
ALTER TABLE db_connection_conf ADD COLUMN file_path VARCHAR(500) DEFAULT NULL COMMENT 'File path for DuckDB/SQLite/CSV data sources' AFTER db_name;
...
-- ===================================================================
-- Phase 5: Workflow DSL, Skill persistence, Evaluation
-- ===================================================================
...
CREATE TABLE IF NOT EXISTS evaluation_task (
    ...
    report_json MEDIUMTEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS agent_app_definition (
    ...
    team_context MEDIUMTEXT DEFAULT NULL COMMENT 'JSON: flow reference for awel_layout, agent selection for auto_plan',
...
ALTER TABLE agent_execution ADD COLUMN conversation_id BIGINT DEFAULT NULL AFTER workspace_id;
...
-- ============================================================
-- Sandbox module
-- sandbox_execution_log: audit log — one row per sandbox code execution.
